...
namespace NBidi
{
    ...
    public static class NBidi
    {
        ...
        private class Paragraph
        {
            ...
            {
                UnicodeDecompositionType decompType = UnicodeCharacterDataResolver.GetUnicodeDecompositionType(ch);
                if (decompType != UnicodeDecompositionType.Isolated &&
                    decompType != UnicodeDecompositionType.Initial &&
                    decompType != UnicodeDecompositionType.Medial &&
                    decompType != UnicodeDecompositionType.Final)
                {
                    builder.Append(ch);
                    return;
                }
