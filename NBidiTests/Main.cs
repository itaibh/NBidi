...
namespace NBidiTests
{
    class TestsMain
    {
        static void Main(string[] args)
        {
            ...
            NBidi.NBiDiArabicShapingTest arabicTests = new NBidi.NBiDiArabicShapingTest();
            arabicTests.Test07ArabicAlefLamKafIndexing();
            arabicTests.Test08ArabicLamAlefKafIndexing();
        }
