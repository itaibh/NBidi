...
namespace NBidi
{
    ...
    public class NBiDiArabicShapingTest
    {
        ...
        public void Test07ArabicAlefLamKafIndexing()
        {
            ...
            Assert.AreEqual(new int[] { 2, 1, 0 }, indexes, "wrong indexing.");
            Assert.AreEqual(new int[] { 1, 1, 1 }, lengths, "wrong lengths.");
        }
        ...
        public void Test08ArabicLamAlefKafIndexing()
        {
            ...
            Assert.AreEqual(new int[] { 1, 0 }, indexes, "wrong indexing.");
            Assert.AreEqual(new int[] { 2, 1 }, lengths, "wrong lengths.");
